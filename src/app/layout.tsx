    ...
    >
      <body className="min-h-full flex flex-col font-sans bg-[#1A1F1D] print:bg-white text-foreground print:text-black relative">
        ...
        <div className="fixed top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0 print:hidden">
          <svg
            className="absolute w-full h-full text-[#4CAF50]"
            xmlns="http://www.w3.org/2000/svg"
            preserveAspectRatio="none"
          >
            {/* Abstract dark green blob - bottom right */}
            <path
              d="M 60% 100% C 70% 70%, 100% 60%, 100% 100% Z"
              fill="#1A281E"
              opacity="0.8"
            />
            ...
            <path
              d="M -10% 50% Q 20% 30% 50% 60% T 110% 40%"
              fill="none"
              stroke="#25352A"
              strokeWidth="1"
              opacity="0.5"
            ...
            <rect
              ...
              height="8"
              fill="currentColor"
              transform="rotate(45 80% 45%)"
              className="opacity-60 drop-shadow-[0_0_8px_rgba(76,175,80,0.8)]"
            />
            <rect
              x="15%"
              y="75%"
              ...
              height="10"
              fill="currentColor"
              transform="rotate(45 15% 75%)"
              className="opacity-40 drop-shadow-[0_0_8px_rgba(76,175,80,0.8)]"
            />
            <rect
              x="75%"
              y="15%"
              ...
              className="opacity-80 drop-shadow-[0_0_8px_rgba(76,175,80,0.8)]"
            />
            <rect
              x="35%"
              y="85%"
              ...
              height="8"
              fill="currentColor"
              transform="rotate(45 35% 85%)"
              className="opacity-50 drop-shadow-[0_0_8px_rgba(76,175,80,0.8)]"
            />
            <rect
              x="55%"
              y="25%"
              ...
              height="6"
              fill="currentColor"
              transform="rotate(45 55% 25%)"
              className="opacity-30 drop-shadow-[0_0_8px_rgba(76,175,80,0.8)]"
            />
          </svg>
